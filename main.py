...
pygame.mixer.music.load("sonidos/musicadefondo.ogg")
...
K_Nave = 0
K = 0
sonidodisparo=pygame.mixer.Sound("sonidos/shoot.ogg")
impacto=pygame.mixer.Sound("sonidos/explosion.ogg")
destruirmete=pygame.mixer.Sound("sonidos/invaderkilled.ogg")
destruirplaneta=pygame.mixer.Sound("sonidos/planetaexpl.ogg")
